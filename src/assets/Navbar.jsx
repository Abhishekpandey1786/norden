  ...
  return (
    <div className="bg-blue-50  shadow-sm">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between px-4  md:px-10 py-4 space-y-4 md:space-y-0">
        ...
        <button className="bg-amber-400 text-white px-4 py-2 hover:bg-amber-700 transition ">
          <Link to="/Shop"><FaSearch className="hover:active:scale-75" /></Link>  
          </button>
        </div>
        ...
        <div className="relative ">
          <Link to="/Cart">
            <FaShoppingCart className="text-amber-400 hover:transform-75 text-2xl md:text-3xl active:scale-75 " />
          </Link>
      ...
      <div className="bg-amber-400 py-4">
        <ul className="flex flex-wrap justify-center gap-6 text-sm sm:text-base text-white font-medium px-4">
          <Link to="/">
            <li className="hover:text-blue-100 cursor-pointer hover:active:scale-75">
              Home
            </li>
          </Link>
          <Link to="/Shop">
