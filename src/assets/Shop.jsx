...
const products = [
  {
    ...
    image:
      "https://www.onesolutionavshop.store/wp-content/uploads/2025/04/avast-antitrack-premium-600x600.jpg",
    oldPrice: "$39.99",
    price: "$35.99",
    sale: true,
    discount: "10%",
  },
  {
    ...
    image:
      "https://www.onesolutionavshop.store/wp-content/uploads/2025/04/secure-vpn-1_Year__5_Devices-1-600x600.jpg",
    oldPrice: "$41.99",
    price: "$33.99",
    sale: true,
    discount: "39%",
  },
  {
    ...
    image:
      "https://www.onesolutionavshop.store/wp-content/uploads/2025/04/avast-internet-2-year-600x600.jpg",
    oldPrice: "$39.99",
    price: "$36.99",
    sale: true,
    discount: "",
  },
  {
    ...
    title: "Avast Internet Security 2-years / 1-pc – Global",
    image:
      "https://www.onesolutionavshop.store/wp-content/uploads/2025/04/secure-vpn-1_Year__5_Devices-600x600.jpg",
    oldPrice: "$39.99",
    price: "$36.99",
    sale: true,
    discount: "",
  },
  {
    ...
    title: "Avast Internet Security 2-years / 1-pc – Global",
    image:
      "https://www.onesolutionavshop.store/wp-content/uploads/2025/04/avg-antivirus-10-device-600x600.jpg",
    oldPrice: "$39.99",
    price: "$36.99",
    sale: true,
    discount: "",
  },
  {
    ...
    title: "Avast Internet Security 2-years / 1-pc – Global",
    image:
      "https://www.onesolutionavshop.store/wp-content/uploads/2025/04/avg-internet-600x600.jpg",
    oldPrice: "$39.99",
    price: "$36.99",
    sale: true,
    discount: "",
  ...
  },
  {
    ...
    title: "Avast Internet Security 2-years / 1-pc – Global",
    image:
      "https://www.onesolutionavshop.store/wp-content/uploads/2025/04/avg_securevpn-600x600.jpg",
    oldPrice: "$39.99",
    price: "$36.99",
    sale: true,
    discount: "",
  },
  {
    ...
    title: "Avast Internet Security 2-years / 1-pc – Global",
    image:
      "https://www.onesolutionavshop.store/wp-content/uploads/2025/04/mcafee-antivirus.webp",
    oldPrice: "$39.99",
    price: "$36.99",
    sale: true,
    discount: "",
